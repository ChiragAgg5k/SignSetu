...
labels_dict = {i: str(i) for i in range(10)}  # Numbers '0' to '9'

# Example of correcting prediction offset:
def get_label(prediction):
    # Assuming the prediction is zero-indexed and should map directly
    return labels_dict[prediction]

# Example usage
prediction = 0  # Replace this with your prediction output
print(get_label(prediction))  # This should print '0' for prediction 0
